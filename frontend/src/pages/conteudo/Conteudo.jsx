...
function CarouselPreviewSection({
  ...
  onRetry, onBack, onCopy, onDownload, onSave, onApplyChanges, onNewCarousel,
}) {
  ...
  return (
    <div data-testid="agent4-result">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Button onClick={onNewCarousel} variant="default" className="gap-2 bg-emerald-600 hover:bg-emerald-700" data-testid="new-carousel-button">
          <Sparkles size={14} />Gerar Novo Carrossel
        </Button>
      </div>
    </div>
  );
